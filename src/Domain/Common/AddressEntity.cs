...
namespace Domain.Common
{
    public class AddressEntity : AuditableEntity
    {
        ...
        /// <summary>
        /// Returns if address lat lng coordinates are within "mi" miles
        /// </summary>
        /// <param name="lat1"></param>
        /// <param name="lon1"></param>
        /// <param name="mi"></param>
        /// <returns></returns>
        public bool WithinMiles(double? lat1, double? lon1, double mi)
        {
            if (lat1 == null || lon1 == null || mi == double.MaxValue) return true;
            return HaversineDistance(lat1.Value, lon1.Value) <= mi;
        }
